...
<head lang="es">
	...
	<title>Banco | ProjectManager</title>
<%
...
<body>
	<div class="container-narrow">
	  ...
	  <div class="row-fluid">
      	<div class="span9">
      		<h3 class="no-margin"><% if (id != 0) { %>Editar<% } else { %>Nuevo<% } %> Banco</h3>
      	</div>
      ...
      <div>
      <form class="form-horizontal" action="<%= ruta %>/AddBanco.do">
      	  <% if (id != 0) { %>
      	  <input type="hidden" id="Id_Banco" name="Id_Banco" value="<%=id%>" />
		  ...
		  <div class="control-group">
		    ...
		    <div class="controls">
		      <input type="text" id="nombre" name="nombre" value="<%=myBank.getNombre()%>" placeholder="Nombre del Banco">
		    </div>
		  </div>
		  <div class="control-group">
		  ...
		  <div class="control-group">
		    <div class="controls">
		      ...
		      <a href="<%= ruta %>/catalogos/Bancos.jsp" class="btn">Cancelar</a>
		    </div>
		  </div>
		</form>
      </div>
