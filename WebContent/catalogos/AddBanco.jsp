...
String mensaje = request.getParameter("mensaje");
	int id = 0;
	try {
		id = Integer.parseInt(request.getParameter("Id_Banco"));
	} catch (Exception e) {
		id = 0;
	}
...
<td valign="top" width="100%">
	...
	<br />
	<br />
		<form action="../AddBanco.do" method="post" id="form2"  style="background-color:#fff;color:#033C24;width:'100%';">
			<h1>
			...
			<td align="left">
			<input id="nombre" style="width:125px" name="nombre" type="text"
						size="10" value="<%=myBank.getNombre()%>" /><br />
						</td>
			</tr>
			<tr>
			<td align="left">
			...
			<select name="estado" style="width:128px" id="estado">
		 		<option value="1" <% if (myBank.getEstado().contains("1")){ %> selected="selected"<% } %> >Activo</option>
		 		<option value="0" <% if (myBank.getEstado().contains("0")){ %> selected="selected"<% } %> >Inactivo</option>
		 		</select>
			</td>
 ...
 <%-- <input id="estado" name="estado"
						type="text" size="10" value="<%=myBank.getEstado() %>" /><br /> --%>
				</p>
	...
	<br />
				...
				%>
				 ...
				 <input
					type="hidden" id="Id_Banco" name="Id_Banco" value="<%=id%>" />
				<p class="submit">
					<button type="submit" onclick="this.form.accion.value='edit';">Editar Banco</button>
				</p>
				<%
					} else {
				%>
				...
				<p class="submit">
					...
					<button type="submit" onclick="this.form.accion.value='nuevo';">Agregar Banco</button>
				</p>
				<%
					}
				%>
